...
This script does the actual download work by querying the SQLite database file for the links you want, downloading the streams, merging them into MKVs, and labelling them. 
